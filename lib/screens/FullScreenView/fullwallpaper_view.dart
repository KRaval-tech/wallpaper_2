...
class _FullScreenWallpaperPageState extends State<FullScreenWallpaperPage> with SingleTickerProviderStateMixin{
  ...
  //           content: Text("This is a premium wallpaper. You need to subscribe to view it."),
  //           actions: [
  //             TextButton(
  //               onPressed: () {
    ...
    return Scaffold(
      body: Container(
        ...
        Image.network(
            ...
            // // Background Image - Use the image fetched from API
            // imageUrl.isNotEmpty
            //     ? Image.network(
            //   imageUrl, // Display image from API
            //   fit: BoxFit.cover,
            //   height: double.infinity,
            //   width: double.infinity,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        // Center Control Column (Icons and Circle)
                        // Column(
                        //   children: [
                        //     Container(
                        //       height: 130,
                        ...
                        //                 _showBottomSheet(); // Show bottom sheet on swipe up
                        //               } else if (details.primaryVelocity! > 0) {
                        //                 Navigator.pop(context); // Close the bottom sheet on swipe down
                        //               }
                        //             },
                        //             child: Container(
                                    ...
                                    children: [
                                      ...
                                      Transform.translate(
                                        ...
                                        child: GestureDetector(
                                          onVerticalDragEnd: (details) {
                                            if (details.primaryVelocity! < 0) {
                                              // Swipe up - Start animation and show bottom sheet
